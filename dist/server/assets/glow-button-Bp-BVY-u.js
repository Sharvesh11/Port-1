  ...
  ({ className, variant = "primary", children, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.button,
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-shimmer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative flex items-center gap-2", children })
        ]
      }
    );
  }
